...
(function () {
	...
	coinjs.bech32 = { 'charset': 'qpzry9x8gf2tvdw0s3jn54khce6mua7l', 'version': 0, 'hrp': 'nu' };

	coinjs.compressed = false;

	/* other vars */
	coinjs.developer = 'NUsakuzewXApASPRhQayMpn9LU35Tit2Ab'; //nusacoin
	...
	*/
	...
	coinjs.hd = function (data) {
		...
		r.master = function (pass) {
			...
			var I = hasher.getHMAC("Nusacoin seed", "TEXT", "SHA-512", "HEX");
	...
	coinjs.transaction = function () {
		...
		r.listUnspent = function (address, callback) {
			...
			coinjs.ajax('https://apinusa.taobot.org/utxos/' + address, callback, "GET");
		}
		...
		r.broadcast = function (callback, txhex) {
			...
			coinjs.ajax('https://apinusa.taobot.org/broadcast', callback, "POST", ["raw=" + tx]);
		}
